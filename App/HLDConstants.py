...
class HLDConstants():
    ...
    display_fields = ListMap([
        ...
        ("charDeaths", DisplayInfo("int", "Total Deaths")),
        ("checkAmmo", DisplayInfo("float", "Grenade Ammo")),
        ("checkBat", DisplayInfo("float", "Gun Ammo (%)")),
        #("checkCID", lambda sd: sd.get("checkCID"), DisplayInfo("index", "Checkpoint ID", None)),
        ("checkHP", DisplayInfo("int", "Health")),
        ("checkRoom", DisplayInfo("int", "Room ID", roomNames)),
        ("checkStash", DisplayInfo("int", "Medkits")),
        ("checkX", DisplayInfo("float", "X Position")),
        ("checkY", DisplayInfo("float", "Y Position")),
        #"cl": ["map", "int", "list", "int"],
        ...
        #("cues", lambda sd: sd.get("cues"), DisplayInfo("?", "?", None)),
        #"dateTime": ["float"],
        #"destruct": ["map", "int", "list", "float"],
        ("drifterkey", DisplayInfo("int", "Keys")),
        #"enemies": ["map", "int", "list", "float"],
        ("eq00", DisplayInfo("dropdown", "Gun Slot 1", gun_ids)),
        ("eq01", DisplayInfo("dropdown", "Gun Slot 2", gun_ids)),
        ("fireplaceSave", DisplayInfo("checkbox", "Post-Credits Scene")),
        ("gameName", DisplayInfo("str", "Savefile Name")),
        ("gear", DisplayInfo("int", "Unspent Gearbits")),
        #"gearReminderTimes": ["float"],
        #"gunReminderTimes": ["float"],
        ("halluc", DisplayInfo("int", "Judgement Cutscenes")),
        ("hasMap", DisplayInfo("checkbox", "Map Collected")),
        #"healthKits": ["list", "int"],
        ("healthUp", DisplayInfo("int", "Extra Medkit Slots")),
        #"mapMod": ["map", "int", "list", "int"],
        #"newcomerHoardeMessageShown": ["float"],
        ("noSpawn", DisplayInfo("checkboxlist", "Dog Encounters", nospawn_flags)),
        ("noviceMode", DisplayInfo("checkbox", "Novice Mode")),
        #"playT": ["float"],
        #"rooms": ["list", "int"],
        ...
        ("specialUp", DisplayInfo("int", "Max Grenades")),
        #"successfulCollectTimes": ["float"],
        #"successfulHealTimes": ["float"],
        #"successfulWarpTimes": ["float"],
